...
class Model_Table extends CI_Model
{
    ...
    public function productStock($productId, $size_id, $branchId)
    {
        $stockQuery = $this->db->query("select * from tbl_currentinventory where product_id = ? and Size_ID = ? and branch_id = ?", [$productId, $size_id, $branchId]);
