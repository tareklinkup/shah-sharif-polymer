    ...
    <div class="col-xs-12">
        ...
        <div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" id="sizename" name="sizename" placeholder="Size Name"
                        value="<?php echo $selected->Size_Name; ?>" class="col-xs-10 col-sm-4" />
                    <input name="id" id="id" type="hidden" value="<?php echo $selected->Size_SlNo; ?>" />
                </div>
            </div>
    ...
    <div class="col-xs-12">
        ...
        <div id="saveResult">
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    <?php 
					$query = $this->db->query("SELECT * FROM tbl_size where status='a'");
					$row = $query->result();
					 ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="hidden-sm hidden-xs action-buttons">
                                ...
                                <a class="green" href="<?php echo base_url() ?>sizeedit/<?php echo $row->Size_SlNo; ?>"
                                    title="Edit" onclick="return confirm('Are you sure you want to Edit this item?');">
                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                </a>

                                <a class="red" href="#" onclick="deleted(<?php echo $row->Size_SlNo; ?>)">
...
function submit() {
    var unitname = $("#sizename").val();
    var id = $("#id").val();
    if (unitname == "") {
        $("#sizename").css("border-color", "red");
        return false;
    }
    var inputdata = 'sizename=' + unitname + '&id=' + id;
    alert(inputdata);
