            ...
            <div class="col-md-6">
                ...
                <!-- <div class="form-group clearfix">
                    ...
                    <div class="col-md-7">
                        ...
                        <v-select v-bind:options="sizes" label="Display_Size" v-if="sizes.length > 0"
                            v-model="selectedSize"></v-select>
                    </div>
                    <div class="col-md-1" style="padding:0;margin-left: -15px;"><a href="/size" target="_blank"
                            class="add-button"><i class="fa fa-plus"></i></a></div>
                </div> -->
...
new Vue({
    ...
    methods: {
        ...
        saveProduct() {
            ...
            //this.product.Size_ID = this.selectedSize.Size_SlNo;
