                            ...
                            <form v-on:submit.prevent="addToCart">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-9">
                                        <div class="row">
                                            <div class="col-xs-5">
                                                <input type="number" id="ProductDiscountPercent" placeholder="%"
                                                    step="0.01" min="0.00" class="form-control"
                                                    v-model="Product_DiscountPercent" v-on:input="productTotal" />
                                            </div>
                                            <div class="col-xs-1 no-padding">Tk.</div>
                                            <div class="col-xs-6">
                                                <input type="number" id="ProductDiscountTaka" placeholder="Taka"
                                                    step="0.01" min="0.00" class="form-control"
                                                    v-model="selectedProduct.Product_DiscountTaka"
                                                    v-on:input="productTotal" />
                                            </div>
                                        </div>
                                    </div>
    ...
    methods: {
        ...
        productTotal() {
            ...
            this.selectedProduct.total = (parseFloat(this.selectedProduct.quantity) * parseFloat(this
                .selectedProduct.Product_SellingPrice - this.selectedProduct.Product_DiscountTaka)).toFixed(
                2);
        },
        onSalesTypeChange() {
        ...
        async productOnChange() {
            if ((this.selectedProduct.Product_SlNo != '' || this.selectedProduct.Product_SlNo != 0) && (this
                    .selectedSize.Size_SlNo != '' || this.selectedSize.Size_SlNo != 0) && this
        ...
        calculateTotal() {
            ...
            this.sales.total = ((parseFloat(this.sales.subTotal) + parseFloat(this
