                            ...
                            <div class="col-md-9">
                                <form v-on:submit.prevent="addToCart()">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-control"
                                                v-bind:style="{display: sizes.length > 0 ? 'none' : ''}"></select>
                                            <v-select v-bind:options="sizes" v-model="selectedSize" label="Display_Size"
                                                v-on:input="onChangeProduct"
                                                v-bind:style="{display: sizes.length > 0 ? '' : 'none'}">
                                            </v-select>
                                        </div>
                                    </div>
    ...
    methods: {
        ...
        async onChangeProduct() {
            ...
            this.productStock = await this.getProductStock(this.selectedProduct.Product_SlNo, this
                .selectedSize.Size_SlNo);
            this.$refs.quantity.focus();

        },

        async getProductStock(productId, size_id) {
