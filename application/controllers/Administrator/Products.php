...
class Products extends CI_Controller
{
    ...
    public function getProducts()
    {
        ...
        $products = $this->db->query("
            ...
            left join tbl_size s on s.Size_SlNo = p.Size_ID
            where p.status = 'a'
            $clauses
    ...
    public function getProductStock()
    {
        ...
        $stock = $this->mt->productStock($inputs->productId, $inputs->size_id, $this->brunch);
        echo $stock;
    }
        ...
        $stock = $this->db->query("
            select
                ...
                (select ifnull(sum(prd.PurchaseReturnDetails_ReturnQuantity), 0) 
                    ...
                    and prd.PurchaseReturnDetailsSize_ID = s.Size_SlNo 
                ...
                (select ifnull(sum(srd.SaleReturnDetails_ReturnQuantity), 0)
                    ...
                    and srd.SaleReturnDetailsSize_ID = s.Size_SlNo 
            ...
            GROUP BY pd2.Product_IDNo, pd2.Size_ID
        ")->result();
