            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5 text-right">
                        ...
                        <strong>Marketing Officer:</strong> {{ sales.Employee_Name }}<br>
                        ...
                        <table _a584de>
                            ...
                            <tbody>
                                <tr v-for="(product, sl) in cart">
                                    ...
                                    <td>{{ parseFloat((100 * product.SaleDetails_Discount) / product.SaleDetails_Rate).toFixed(2) }} % </td>
                    ...
                    <body>
                        <div class="container">
                            ...
                            <div style="position:fixed;left:0;bottom:0;width:100%;">
                                <div class='row'>
                                    <div class='col-xs-12'>
                                        <img src='/uploads/footer.jpeg' height='80px' width='100%'/>
                                    </div>
                                </div>
                            </div>
                        </div>
